...
|-----|---------|--------|--------|
| [student-activity-feed](PRDs/student-activity-feed.md) | Aba Atividades: acompanhamento diario do aluno com feedback, treino, cardio e refeicoes | 🔄 aprovado, fase 0-2 entregues | `feature/student-activity-feed` |
...
| 71 | **Direito de correção (Art. 18, III) sem caminho.** O aluno não tem como editar uma observação já enviada, nem de treino nem de refeição. Não é regressão — vale para todo o histórico —, mas passou a incomodar mais desde que o texto do feedback ficou visível para o especialista. Levantado no parecer LGPD do PRD `student-activity-feed` | 🟡 Média | [PRD](PRDs/student-activity-feed.md) |
