...
| Eventos auditáveis append-only | `docs/adr/0037-eventos-de-seguranca-sao-imutaveis-minimos-e-investigaveis.md`; migrations | [E] ADR define a intenção. | [—] Nenhuma tabela/migration/serviço de trilha de auditoria foi localizada nesta varredura. A ADR não é evidência operacional. |
