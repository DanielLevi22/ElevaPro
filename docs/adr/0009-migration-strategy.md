# Migrations aplicadas pelo pipeline, não à mão
...
O [ADR-0003](0003-environment-strategy.md) definiu 3 ambientes (Local → Preview →
...
- **Contras:** requer plano pago. O ADR-0003 escolheu deliberadamente a topologia
  de 2 projetos free.
